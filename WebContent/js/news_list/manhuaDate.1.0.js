...
$(function() {
	$.fn.manhuaDate = function(options) {
		...
		if($("#calender").length<=0){
			$("#main_right_up").prepend("<div class='calender'><div class='calenderContent'><div class='calenderTable'><div class='getyear'><a class='preMonth' id='preMonth'>&lt; &lt;</a><select   id='year' class='disabled'></select ><select id='month'  class='disabled'></select><a class='nextMonth' id='nextMonth'>&gt; &gt;</a></div><div class='tablebg'><table id='calender' class='calendertb' cellpadding='0' cellspacing='1'><tr bgcolor='white'  ><th class='weekend' style='border:0px'>日</th><th style='border:0px'>一</th><th style='border:0px'>二</th><th style='border:0px'>三</th><th style='border:0px'>四</th><th style='border:0px'>五</th><th class='weekend noborder' style='border:0px'>六</th></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2'></td></tr></table></div></div></div></div>");
		}
		var $mhInput = $(this);
