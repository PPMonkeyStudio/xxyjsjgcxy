...
//	}
	 ...
	 * 
	 */
	var url = "/xxyjsjgcxy/sadmin/admin_page_list_admin?page_list_admin.pageIndex=1&searchAdminList.sqrt="
	+ sqrt
	+ "&searchAdminList.sqrt_sc="
	+ sqrt_sc
	+ "&searchAdminList.name="
	+ input_name.value;
